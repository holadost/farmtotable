...
func (aragorn *Aragorn) Run() {
	...
	r.GET("/api/v1/resources/users/register", aragorn.registerUser)

	// Supplier APIs.
	r.GET("/api/v1/resources/suppliers/fetch_all", aragorn.getAllSuppliers) // Administrator API. Returns all the suppliers.
	r.GET("/api/v1/resources/suppliers/register", aragorn.registerSupplier) // Administrator API. // Register Supplier.
	...
	r.GET("/api/v1/resources/items/register", aragorn.registerItem)  // Administrator API. Registers item.
	r.GET("/api/v1/resources/items/remove", aragorn.removeItem)      // Administrator API. Removes item
	...
	r.GET("/api/v1/resources/auctions/register_bid", aragorn.registerBid)      // Registers a new bid by the user.
